...
Public Class Maze
    ...
    Public Overrides Sub UpdateActor(ByVal deltaTime As Double)
        If (gameClear = True) Then
            mClearPict.SetState(State.EActive)
        ...
        ElseIf (resetEnd = True) Then
            ...
            mShadow.SetState(State.EActive)
    ...
    Public Sub GenerateMap()
        ...
        Next
    End Sub
    Public Function GetTilePos(ByVal i As Integer, ByVal j As Integer) As Vector2
        Dim pos As Vector2 = New Vector2((i + 1) * 1.0, (j + 1) * 1.0) * mTileSize
        Return pos
    End Function
